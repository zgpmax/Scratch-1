...
You can start using Scratch and find more info on the [Scratch home page](http://scratch.mit.edu/). Links to some fun activities that will have you creating your own awesome Scratch projects in no time are included below. Before getting started, head to the Scratch home page and create an account so that you can save your projects and share them with other users.
<a href="http://scratch.mit.edu" target="new">Scratch home page</a>
## Activities
